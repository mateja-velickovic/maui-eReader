const books = [
  {
    ...
    numberOfPages: 236,
    pdfLink: 'https://flipbooklets.com/pdfflipbooklets/une-boussole-sur-l-chiquier-extraits#page1',
  ...
  },
  {
    ...
    numberOfPages: 254,
    pdfLink: 'https://fr.wikisource.org/wiki/Vingt_mille_lieues_sous_les_mers/Texte_entier',
